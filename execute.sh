...
SOURCE_XNB_FOLDER=Terraria.v1.3.3-read-only/Content/Images
...
TARGET_XNB_FOLDER=Terraria.v1.3.3/Content/Images
...
function createRelease() {
    ...
    echo "Enhanced version of the textures of Terraria 1.3.3" > $3/README.txt
    echo "" >> $3/README.txt
...
createRelease v0.7-1.3.3 $TARGET_XNB_FOLDER $RELEASE_FOLDER
# createRelease v0.7-noblend-1.3.3 $TARGET_XNB_FOLDER $RELEASE_FOLDER
